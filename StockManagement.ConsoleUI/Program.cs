...
{
    new Category(1 , "Giyim" , "Giyim açıklaması"),
    new Category(2 , "Teknoloji" , "Teknoloji Açıklaması"),
    new Category(3 , "Dekarasyon" , "Dekorasyon Açıklaması"),
    new Category(4 , "Spor" , "Spor Açıklaması"),
};
